...
public class FirstMainClass extends JFrame {
    ...
    private void addModelToUniverse() throws IOException{
        scene = getSceneFromFile("/home/alexander/Documents/Java/Boat/boat.obj");
    ...
    private void setPlaneElementsList() {
        ...
        root.removeChild(nameMap.get("boat"));
        wholePlane.addChild(nameMap.get("boat"));
    ...
    private void addAppearance(){
        ...
        planeAppearance.setTexture(getTexture("/home/alexander/Documents/Java/Boat/wood3.jpg"));
        TextureAttributes texAttr = new TextureAttributes();
        texAttr.setTextureMode(TextureAttributes.COMBINE);
        planeAppearance.setTextureAttributes(texAttr);
        planeAppearance.setMaterial(getMaterial());
        Shape3D plane = nameMap.get("boat");
        plane.setAppearance(planeAppearance);
    }

    private void addImageBackground(){
        TextureLoader t = new TextureLoader("/home/alexander/Documents/Java/lake.jpg", canvas);
    ...
    public static void main(String[]args){
        try {
            ...
            BoatAnimation planeMovement = new BoatAnimation(wholePlane, transform3D, window);
