...
namespace DigitsPower
{
    static class HelpMethods
    {
        ...
        public static MyList<int> ToWNAF(BigInteger power, int w)
        {
            ...
            for (int i = 0; i < w; i++)
                str = str + '1';
            BigInteger mask = Convert.ToInt64(str, 2);
            */
    ...
    public partial class MainForm : Form
    {
        void Show(BigInteger num, BigInteger pow, BigInteger mod, int window, double table)
        {
            for (int i = 0; i < OperationsList.CheckedIndices.Count; i++)
            {
                ...
                if (OperationsList.CheckedIndices[i] == 10) { OperationsResult.Items.Add("NAF Binary RL\t\t: " + (PowFunctions.NAFBinaryRL(num, pow, mod).ToString())); OperationsResult.Update(); }
                if (OperationsList.CheckedIndices[i] == 11) { OperationsResult.Items.Add("NAF Binary LR\t\t: " + (PowFunctions.NAFBinaryLR(num, pow, mod).ToString())); OperationsResult.Update(); }
                if (OperationsList.CheckedIndices[i] == 16) { OperationsResult.Items.Add("Add Sub RL\t\t: " + (PowFunctions.AddSubRL(num, pow, mod).ToString())); OperationsResult.Update(); }
                if (OperationsList.CheckedIndices[i] == 17) { OperationsResult.Items.Add("Add Sub LR\t\t: " + (PowFunctions.AddSubLR(num, pow, mod).ToString())); OperationsResult.Update(); }
                ...
                if (OperationsList.CheckedIndices[i] == 12) { OperationsResult.Items.Add("NAF Slide RL\t\t: " + (PowFunctions.NAFSlideRL(num, pow, mod, window, out table).ToString())); OperationsResult.Update(); }
                if (OperationsList.CheckedIndices[i] == 13) { OperationsResult.Items.Add("NAF Slide LR\t\t: " + (PowFunctions.NAFSlideLR(num, pow, mod, window, out table).ToString())); OperationsResult.Update(); }
                if (OperationsList.CheckedIndices[i] == 14) { OperationsResult.Items.Add("NAF Window RL\t\t: " + (PowFunctions.NAFWindowRL(num, pow, mod, window, out table).ToString())); OperationsResult.Update(); }
                if (OperationsList.CheckedIndices[i] == 15) { OperationsResult.Items.Add("NAF Window LR\t\t: " + (PowFunctions.NAFWindowLR(num, pow, mod, window, out table).ToString())); OperationsResult.Update(); }
                //if (OperationsList.CheckedIndices[i] == 16) { OperationsResult.Items.Add("wNAF Slide RL\t\t: " + (PowFunctions.wNAFSlideRL(num, pow, mod, window, out table).ToString())); OperationsResult.Update(); }
                //if (OperationsList.CheckedIndices[i] == 17) { OperationsResult.Items.Add("wNAF Slide LR\t\t: " + (PowFunctions.wNAFSlideLR(num, pow, mod, window, out table).ToString())); OperationsResult.Update(); }
